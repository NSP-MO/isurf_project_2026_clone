        ...
        areas.forEach(area => {
            ...
            tr.innerHTML = `
                ...
                <td style="padding: var(--space-4); text-align: right; white-space: nowrap;">
                    <button class="ds-btn-outline" style="padding: 6px 12px; font-size: 13px; margin-right: 8px;" onclick="openAreaRulesModal(${area.id}, '${area.name}')">
                    ...
                    <button class="ds-btn-outline" style="padding: 6px 12px; font-size: 13px;" onclick="openManageDevicesModal(${area.id}, '${area.name}')">
