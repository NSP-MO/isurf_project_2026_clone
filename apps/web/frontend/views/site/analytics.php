...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    async function renderAreaContent(areaId, areaName) {
        ...
        content.innerHTML = `
            <div class="ds-grid ds-grid-cols-1 md-grid-cols-3">
    ...
    async function loadAreaCharts(areaId) {
        const phData = await ISURF_API.getHistory(areaId, 'pH', 24*7);
        ...
        document.getElementById('total-water').textContent = waterData.total_discharged;
